...
import { FaEdit, FaTrashAlt, FaPlus, FaTimes, FaCalendarAlt, FaMoneyBillWave, FaClock, FaInfoCircle, FaUser } from 'react-icons/fa';
import { getEmployers } from '../services/employerService';
import { getAdjustments, createAdjustment, updateAdjustment, deleteAdjustment } from '../services/adjustmentService';
...
const EmployerAdjustments = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const parsedValue = form.value_type === 'hours' ? parseInt(form.value) : parseFloat(form.value);
        ...
        try {
            ...
            setForm({ date: '', value: '', value_type: 'money', kind: 'addition', reason: '' });
            setIsEditing(false);
                ...
                <Container fluid className={styles.container}>
                    <div className={styles.pageHeader}>
                        <div className={styles.headerContent}>
                            ...
                            <p className={styles.pageDescription}>Manage salary adjustments and deductions for employees</p>
                        </div>
                                        ...
                                        <div className={styles.employeeInfo}>
                                            ...
                                            <div className={styles.infoItem}>
                                                ...
                                                <span className={styles.infoValue}>
                                                    ${employers.find(emp => emp.id === parseInt(employerId))?.salary || 0}
                                                </span>
                                            </div>
                                        </div>
                                    )}
                                ...
                                <Card className={styles.sidebarCard}>
                                    <Card.Body>
                                        ...
                                        <Form onSubmit={handleSubmit}>
                                            ...
                                            <Form.Group className={styles.formGroup}>
                                                <Form.Label>
                                                    <FaClock className="me-2" /> Value ({form.value_type === 'hours' ? 'hours' : '$'})
                                                </Form.Label>
                                                <Form.Control
                                                    type="number"
                                                    name="value"
                                    ...
                                    <Card className={styles.tableCard}>
                                        <Card.Body>
                                            ...
                                            {adjustments.length === 0 && !loading && !error && (
                                                <div className={styles.noData}>No adjustments found for this employer.</div>
                                            )}
