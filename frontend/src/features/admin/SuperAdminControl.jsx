...
const SuperAdminControl = () => {
  ...
  return (
    ...
    <div >
      ...
      <div className="mb-3">
       <Button className={styles.addButton} variant="primary" onClick={() => navigate("/add-user")}><i className="bi bi-person-plus"></i>  Add User </Button>
      </div>
      </div>
  ...
  <div className="text-center text-muted" style={{ padding: "50px 0" }}>
